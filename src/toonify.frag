...
uniform float colors; // =12.0; // 12.0
uniform float sat_levels; // = 4.0 ; // 4.0
uniform float bri_levels; // = 4.0 ; // 4.0
uniform float edge_thres; // = 0.2; // 0.2;
uniform float edge_thres2; //= 5.0; // 5.0;
